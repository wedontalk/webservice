    ...
    <div id="slider" class="owl-theme section section-cate slideshow_full_width ">
        <div id="slide_banner" class="owl-carousel">
            <div class="item">
                ...
                <img src="{{asset('site/img/banner.jpg')}}" alt="banner chung">
                </a>
            </div>
            <div class="item">
                <a href="/" alt="nitvn2">
                <img src="{{asset('site/img/banner.jpg')}}" alt="nitvn2">
                </a>
            </div>
            <div class="item">
                <a href="/" alt="nitvn3">
                <img src="{{asset('site/img/banner.jpg')}}" alt="nitvn3">
                </a>
            </div>
        </div>
    </div>
            ...
            <div class="row row-flex-safari game-list">
                ...
                <div class="classWithPad">
                    <div class="news_image">
                        <img style="position: absolute;max-width: 79px;height: auto;top: -5px;right: -6px;z-index: 1122;" src="{{asset('site/img/giam.png')}}"/>
                        <a href="/danh-muc/danh-muc-game-free-fire" title="Danh Mục Game Free Fire" class="">
                        <img src="{{asset('site/img/danhmuc.gif')}}" alt="Danh Mục Game Free Fire"></a>
                    </div>
